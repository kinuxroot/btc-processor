...
using LoggerType = decltype(logging::LoggerFactory<logging::Level::Debug>::createLogger("Root", std::make_tuple(
    logging::handlers::StreamHandler<logging::Level::Debug>(logging::formatters::stream::formatRecord),
    logging::handlers::FileHandler<logging::Level::Debug>("file.log", logging::formatters::stream::formatRecord)
)));
